...
This project is indexed by GitNexus as **QuanLyNhaHang2** (2707 symbols, 7413 relationships, 221 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/QuanLyNhaHang2/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/QuanLyNhaHang2/context` | Codebase overview, check index freshness |
| `gitnexus://repo/QuanLyNhaHang2/clusters` | All functional areas |
| `gitnexus://repo/QuanLyNhaHang2/processes` | All execution flows |
| `gitnexus://repo/QuanLyNhaHang2/process/{name}` | Step-by-step execution trace |
